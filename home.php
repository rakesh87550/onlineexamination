  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <p class="para">Please Select Your Subject To Start Exam.....</p><br>
      </div>
      <div class="col-lg-4">
        <!-- starting form -->
        <form action="ques_show.php" method="post">
          <select class="form-control" id="" name="cat">
            ...
            <?php //php category show
            foreach ($profile->cat as $category) { ?>
              <option value="<?php echo $category['id']; ?>"><?php echo $category['cat_name']; ?></option> <!-- show category -->
            <?php } ?>

          </select><br>
          <input class="btn btn-success" type="submit" name="submit" value="Start Exam">
        </form>
        <!-- ending form -->
        <?php
        if (isset($_POST['submit'])) {
          $_SESSION['subject'] = $_POST['cat'];
        }
        ?>
      </div>
    </div>
